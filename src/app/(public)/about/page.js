...
export const metadata = {
  title: "About Us",
  description:
    "Learn about ThinkFortIP — an intellectual property firm focused on technically strong patent, trademark, and copyright filings aligned with business strategy.",
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "AboutPage",
            name: "About ThinkFortIP",
            url: "https://thinkfortip.com/about",
            mainEntity: {
              "@type": "Organization",
              name: "ThinkFortIP",
              ...
              description:
                "ThinkFortIP is an intellectual property firm focused on technically strong patent, trademark, and IP strategy services.",
            },
          }),
        }}
      />
      ...
      <section className="mb-20 flex flex-col lg:flex-row items-center justify-center gap-15 md:px-30 px-10">
        <div className="relative shadow-2xl shadow-[rgb(var(--bg-surface))] rounded-2xl overflow-hidden shrink-0">
          <Image
            ...
            src="/about.png"
            alt="ThinkFortIP team providing intellectual property and patent services"
          />
        </div>
        <div className="text-sm text-slate-600 max-w-2xl">
          ...
          <p className="mt-4">
            ...
            formality. ThinkFortIP exists to help organizations protect
