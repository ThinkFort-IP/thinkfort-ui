...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: `Apply for the ${job.title} role at ThinkFortIP. ${job.summary}`,
    alternates: {
      canonical: `https://thinkfortip.com/careers/${job.id}`,
    },
  };
}
          ...
          <div className="mt-10 space-y-10">
            ...
            <div className="mt-16 p-6 border rounded-2xl bg-gray-50 flex flex-col sm:flex-row justify-between gap-6">
              ...
              <a
                ...
                className="px-6 py-3 bg-[rgb(var(--brand-green))] text-white rounded-full text-center hover:bg-[rgb(var(--btn-hover))]"
              >
                Apply Now
              </a>
            </div>
