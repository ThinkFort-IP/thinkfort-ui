...
export const metadata = {
  title: "FAQs",
  description:
    "Find answers to common questions about ThinkFortIP’s intellectual property, patent, trademark, and IP advisory services.",
  alternates: {
    canonical: "https://thinkfortip.com/faq",
  },
  openGraph: {
    title: "FAQs | ThinkFortIP",
    description:
      "Answers to frequently asked questions about patents, trademarks, and intellectual property services at ThinkFortIP.",
    url: "https://thinkfortip.com/faq",
  },
};
const faqSchema = {
