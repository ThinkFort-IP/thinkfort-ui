export const metadata = {
  ...
  alternates: {
    canonical: "https://thinkfortip.com/privacy-policy",
  },
  robots: {
    index: true,
    follow: true,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "@id": "https://thinkfortip.com/privacy-policy",
            name: "Privacy Policy",
            url: "https://thinkfortip.com/privacy-policy",
            description:
              "Privacy policy explaining how ThinkFortIP collects, uses, protects, and manages personal information.",
            isPartOf: {
              "@type": "WebSite",
