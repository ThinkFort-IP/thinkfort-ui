export const metadata = {
  ...
  alternates: {
    canonical: "https://thinkfortip.com/terms-and-conditions",
  },
  robots: {
    index: true,
    follow: true,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://thinkfortip.com/terms-and-conditions",
            publisher: {
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <section className="mb-8">
                ...
                <div className="prose text-gray-600">
                  <p>
                    Welcome to ThinkFortIP These Terms and Conditions (“Terms”)
                    govern your access to and use of our website
                    [www.thinkfortip.com] (“Website”) and the services provided
                    through it.
                  </p>
                  <p>
              ...
              <section className="mb-8">
                ...
                <div className="prose text-gray-600">
                  ...
                  <p>
                    is the exclusive intellectual property of ThinkFortIP,
              ...
              <section className="mb-8">
                ...
                <div className="prose text-gray-600">
                  ...
                  <ul className="list-disc px-5 py-2 bg-gray-50">
                    <li>
                      ThinkFortIP shall not be liable for any direct, indirect,
              ...
              <section className="mb-8">
                ...
                <div className="prose text-gray-600">
                  <p>
                    You agree to indemnify and hold harmless ThinkFortIP, its
