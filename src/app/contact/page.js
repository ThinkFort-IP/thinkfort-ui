    ...
    return (
        <form className="mt-35 mb-20 flex flex-col items-center text-sm text-slate-800">
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <button type="submit" className="flex items-center justify-center gap-1 mt-5 bg-[rgb(var(--brand-green))] hover:bg-[rgb(var(--btn-hover))] text-white py-2.5 w-full rounded-full transition">
                    Submit Form
