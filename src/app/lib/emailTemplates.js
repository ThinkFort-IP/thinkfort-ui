...
export function welcomeEmailHtml() {
  ...
  <html>
    <head>
      <meta charset="UTF-8" />
      <title>Welcome to ThinkFortIP</title>
    </head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; padding:32px;">
              ...
              <tr>
                <td style="text-align:center; padding-bottom:24px;">
                  <h1 style="margin:0; color:#111827;">Welcome to ThinkFortIP 👋</h1>
              ...
              <tr>
                <td style="color:#374151; font-size:15px; line-height:1.6;">
                  ...
                  <p>
                    Thank you for subscribing to <strong>ThinkFortIP</strong>.
                  ...
                  <p>
                    <a href="https://thinkfortip.com/service"
                  ...
                  <p style="margin-top:24px;">
                    ...
                    simply reply to this email — our experts are happy to help.
                  </p>

                  <p style="margin-top:32px;">
                    Warm regards,<br />
                    <strong>ThinkFortIP</strong>
                  </p>
                </td>
              </tr>
