          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                <p>
                  Welcome to ThinkFortIP
 These Terms and Conditions (“Terms”) govern your access to and use of our website [www.thinkfortip.com] (“Website”) and the services provided through it.
                </p>
                <p>
            ...
            <section className="mb-8">
              ...
              <p>
                ThinkFortIP provides professional services related to
              ...
              <p>
                All services are provided on a best-effort basis and are subject
                to applicable laws, regulations, and professional standards in
                India and other relevant jurisdictions.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600">You are at least 18 years of age.</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-medium text-gray-900 mb-2">Legal Capacity</h3>
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                ...
                <p>
                  is the exclusive intellectual property of ThinkFortIP, unless
                  otherwise stated.
                </p>
                <p>
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                ...
                <ul className="list-disc px-5 py-2 bg-gray-50">
                  <li>
                    Communication via the Website or email is not guaranteed to
                    be secure
                  </li>
                  <li>
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                <ul className="list-disc px-5 py-2 bg-gray-50">
                  <li>
                    Fees for services are communicated separately via proposal,
                    quotation, or engagement letter.
                  </li>
                  <li>
                    Payment terms, scope of work, and timelines are governed by
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                <p>
                  ...
                  convenience. ThinkFortIP does not control or endorse such
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                ...
                <ul className="list-disc px-5 py-2 bg-gray-50">
                  <li>
                    ThinkFortIP shall not be liable for any direct, indirect, incidental, or consequential damages.
                  </li>
                  <li>
                ...
                <p>
                  We are not responsible for decisions taken by users based on Website information.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                <p>You agree to indemnify and hold harmless ThinkFortIP, its directors, employees, and associates from any claims, losses, or liabilities arising from:</p>
                <ul className="list-disc px-5 py-2 bg-gray-50">
                  <li>
            ...
            <section className="mb-8">
              ...
              <div className="prose text-gray-600">
                ...
                <p>
                  Any disputes shall be subject to the exclusive jurisdiction of the courts at [City, State].
                </p>
              </div>
            </section>
