...
const LISTENERS_KEY = "__thinkfortFetchListeners";
const PENDING_KEY = "__thinkfortFetchPending";
const PATCHED_KEY = "__thinkfortFetchPatched";
const ORIGINAL_FETCH_KEY = "__thinkfortOriginalFetch";
